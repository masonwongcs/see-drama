  ...
  if (res.status === 200) {
    ...
    res.data.forEach(async (value, index) => {
      ...
      $("body").append(dramaListWrapper).ready(function () {
        ...
        setTimeout(function () {
          $(".placeholder").remove();
        }, 1000); // carousel.on('dragStart.flickity', () => carousel.find('.slide').css('pointer-events', 'none'));
